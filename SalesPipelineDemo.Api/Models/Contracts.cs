...
public class ColumnDefinition
{
    ...
    public string DataType { get; set; } = "text";   // text | number | enum
    public int Width { get; set; } = 120;
    public bool IsEditable { get; set; }
    public string? EditType { get; set; }            // text | number | dropdown
...
public class PanelField
{
    ...
    public string DataType { get; set; } = "text";   // text | metric | highlight
...
{
    public string Criteria { get; set; } = "";    // "stale" | "missing-owner" | "missing-stage"
